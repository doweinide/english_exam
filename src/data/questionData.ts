...
在马萨诸塞州的剑桥进行了测试，五名司机被要求沿着同一路线行驶三个小时；在新加坡进行了测试，八名司机被要求沿着两条路线之一行驶30分钟。测试显示，在这两个城市，“信号大师”预测交通信号灯活动的准确率分别为98.2%和96.3%。这尤其令人印象深刻，因为在剑桥，测试进行到大约一半时，信号灯从非高峰时间表切换到了下午交通时间表，而在新加坡，信号灯是自适应的，使用埋设在道路下的探测器来确定周围有多少交通流量，从而确定信号何时应该改变。燃料消耗也下降了约20%。因此，“信号大师”减少了挫折感和燃料消耗，并使通勤体验稍微不那么糟糕。`,
  ...
  },
  {
    ...
    questionSets: [{
        ...
        "title": "爱情与逻辑：谬误的故事",
        "description": "讲述了主人公试图用逻辑知识改变女友思维并发展浪漫关系的故事",
        "type": "translation",
        "questions": [
          {
            "id": "t1-1",
            ...
            "textCN": "在我和室友罗伯的交易成功之后，我和波莉有了第一次约会。那一年校园里每个人都有件皮夹克，而罗伯是校足球队员中唯一一个没有皮夹克的，他一想到这个就受不了，于是他和我达成了一项协议，用他的女友换取我的夹克。他可不那么聪明，而他的女友波莉也不太精明。",
            "options": [],
            "correctOptionId": "",
          },
          {
            ...
            "textCN": "但她漂亮而且富有，也没有把头发染成奇怪的颜色或是化很浓的妆。她拥有合适的家庭背景，足以胜任一名坚忍而睿智的律师的女友。如果我能够让我所申请的顶尖律师事务所看到我身边伴随着一位光彩照人、谈吐优雅的另一半，我就很有可能在竞聘中以微弱优势获胜。",
            "options": [],
            "correctOptionId": "",
          },
          {
            ...
            "textCN": "在一起外出度过了美好的一天之后，我驱车来到了高速公路旁一座小山上一棵古老的大橡树下。我的想法有些怪异。而这个地方能够俯瞰灯火灿烂的城区，我觉得它会使人的心情变轻松。我们呆在车子里，我调低了音响并把脚从刹车上挪开。“我们要谈些什么？”她问道。",
            "options": [],
            "correctOptionId": "",
          },
          {
          ...
          },
          {
            ...
            "textCN": "她似乎学得很开心，而我也可以放心地说我的计划正在稳步推进中。我把她送回家，并且定下了下一次约会交谈的日子。",
            "options": [],
            "correctOptionId": "",
          },
          {
            ...
            "textCN": "第二天晚上，坐在那棵橡树下，我说：“今天晚上我们要谈的第一个逻辑谬误叫‘文不对题’。”",
            "options": [],
            "correctOptionId": "",
          },
          {
          ...
          },
          {
            ...
            "textCN": "经过五个夜晚的辛勤努力，我竟然真的将波莉打造成了一个逻辑行家，她总算能够分析思考了。现在应该是时候让我们的关系从学术向浪漫发展了。",
            "options": [],
            "correctOptionId": "",
          },
          {
            ...
            "textCN": "我赞许地对她笑了笑，说：“我们在一起已经度过了五个晚上，相互之间挺合得来，我们是蛮相配的一对。”",
            "options": [],
            "correctOptionId": "",
          },
          {
            ...
            "textCN": "我被逗得笑了起来，她功课还真学得不错，大大超过了我的预期。“亲爱的，”我开口说，同时宽容地拍了拍她的手，“五次约会已经够多了，毕竟你不需要吃掉整个蛋糕才知道它是不是好吃。”",
            "options": [],
            "correctOptionId": "",
          },
          {
            ...
            "textCN": "我又笑了笑，不过不觉得那么有趣了，同时还不能表露出我害怕她学得太好了。再错几步我可就无法挽回了。我决定改变策略，转而尝试奉承她的办法。",
            "options": [],
            "correctOptionId": "",
          },
          {
          ...
          },
          {
            ...
            "textCN": "我极力地保持着平静，说道：“你怎么会甩了我而选择罗伯？看看我，一个聪明过人的学生，一个不同凡响的学者，一个前途无量的人。再看看罗伯，一个肌肉发达的蠢材，一个有了上顿没下顿的家伙。你是否能给我一个充足的理由，为什么要选择跟他？”",
            "options": [],
            "correctOptionId": "",
          },
          {
    ...
    "questions": [
        {
            ...
            "textCN": "当我还是个小男孩时，我住在弗吉尼亚州一个偏远的地区，那时我所认识的男人们从清晨的第一声公鸡啼鸣一直劳作到日落。他们都是些不起眼的农民、牧羊人，勉强度日，或是焊接工、钢铁工或木匠；他们制作橱柜、挖掘沟渠、开采煤炭，或驾驶卡车，这使他们拥有肌肉结实的上臂。他们训练马匹、填塞炉膛、制造轮胎，站在装配线上将零件焊接到冰箱，或是给汽车发动机上润滑剂。到了傍晚或周末，他们也要同样辛苦地劳作，在自己的一小片土地上耕作，修理出了问题的汽车，修复坏掉的百叶窗和漏风的窗户。在仅剩的闲暇时间里，他们会在当地的啤酒作坊或赛马场附近的酒馆里用盛在廉价铜杯中的啤酒将自己灌得烂醉。",
            "options": [],
            "correctOptionId": ""
        },
        {
            ...
            "textCN": "我所认识的那些男人的身躯遭受着种种看得见或看不见的扭曲和伤痛。搬运沉重的物品给他们很多人造成了脊柱病和可怕的伤痛。有些人断了肋骨，掉了手指。在传输带上不停地工作使他们有些人患了溃疡。他们的脚踝和膝盖由于经年累月站立在水泥地上疼痛不已。有些人由于焊接火光损伤视觉感官而遭受部分视觉缺失的折磨。有些时候，打量着他们，我会害怕长大。在我们周围的人中，父亲们看上去总是比母亲们要老。男人衰老得更早，长期遭受着因持续劳作带来的病痛。只有女人才活到年老。",
            "options": [],
            "correctOptionId": ""
        },
        {
            ...
            "textCN": "还有士兵也是男人的工作。据我所知，他们几乎不工作，但当战争一打响，他们很多人都会出于爱国热情而战死在疆场或异域前哨的堡垒前。这就是士兵的作用——他们就像工具，如同扳钳、锤子或螺丝一样。",
            "options": [],
            "correctOptionId": ""
        },
        {
            ...
            "textCN": "这些并非男人们唯一的归宿，我从曾经有过的几位男教师、从看书及看电视中认识到了这一点。但是，那些上电视的男人们——新闻评论员、律师、医生、课征税款的政治家及发号施令的老板们——在我看来就像古老绘画上的人像，遥远而不真实。我不能想象自己长大变成这些精明世故的人中的一员，就像我无法想象自己能变成一个权力至高无上的国君一样。",
            "options": [],
            "correctOptionId": ""
        },
        {
        ...
        },
        {
            ...
            "textCN": "所以，当学校里的女性大吵大嚷，谴责我和我所属的性别，说我们霸占着世间的欢乐时，我很困惑。她们要求从性别歧视的束缚中解放出来。我认为别的男孩（女孩也一样）也会有我这样的迷惑，只要他们成长于一贫如洗的农村，成长于码头边或工厂附近——成长于任何让男人和女人的命运同样苍白和严酷的地方。",
            "options": [],
            "correctOptionId": ""
        },
        {
            ...
            "textCN": "当我在大学里遇到的那些女子们想到男人的享乐和特权时，她们并没有见过我以前认识的那些男人。这些特权阶层的、共和党男人的女儿们渴望继承她们父亲的权力和凌驾世界的贵族身份。她们渴望能对自己的未来拥有发言权。而我也渴望这样。我和这些女儿们之间的区别在于，她们看我时想到的是，我因为自己的性别而自出生起就注定可以成为像她们父亲那样的人，从而也是她们实现自己欲望的敌人。但我比她们更清楚，无论是事实上还是情感上，我都不是她们欲望的敌人。我是她们反抗行动的同盟者。如果那时我就知道如何把这些告诉她们，或如何在中间做一个调停人，她们会相信我吗？她们能够理解吗？",
            "options": [],
            "correctOptionId": ""
        },
        {
            ...
            "textCN": "许多年过去了，如今作为一个有幸与我所认识的最优秀的一些女性共享生活的男人，我对女性的怨愤有了更为深刻的理解。在我自己的人际关系以及我周围的世界中，我看到了性别期望的重负是如何摧毁人的精神、限制男人和女人的潜力的。",
            "options": [],
            "correctOptionId": ""
        },
        {
            ...
            "textCN": "对男人而言，这种重负常常表现为一种无情的压力，要求我们去供养家庭、取得成功、在逆境面前坚强隐忍。从孩童时期我们就被教导，必须成为养家糊口的人、保护者、家庭的顶梁柱。任何脆弱或情感的表露都被视为软弱的标志，于是我们学会把自己的感受深埋心底，即便这些感受正蚕食着我们的灵魂。繁重劳作带来的身体损耗，与压抑真实自我造成的情感损耗相当。",
            "options": [],
            "correctOptionId": ""
        },
        {
            ...
            "textCN": "然而，在追求这些理想的过程中，我们常常忽视这样一个事实：女性也背负着沉重的负担——不仅有家务和照料他人的负担，还有对抗社会期望和性别成见的负担。人们期望她们富有爱心、无私奉献，同时又要雄心勃勃、事业有成。她们会因过于强势或过于被动、过于情绪化或过于冷漠而受到指责。这些矛盾无穷无尽，压力也可能让人难以承受。",
            "options": [],
            "correctOptionId": ""
        },
        {
            ...
            "textCN": "当我回想起小时候认识的那些男人，以及我一生中爱过并尊重的那些女人时，我意识到我们背负的重负不只是个人的，更是集体的。它源于几个世纪以来的性别角色和社会规范，这些规范以这样或那样的方式限制着我们所有人。要真正减轻这一重负，我们必须挑战这些过时的观念，努力构建一个更公平、更有同情心的社会——一个男人和女人都能自由做自己、追求梦想、相互支持而无需恐惧或评判的社会。",
            "options": [],
            "correctOptionId": ""
        },]},{
        "id": "translation-set-1",
        ...
        "questions": [
          {
            ...
            "textCN": "两百年前，全球经历了一场能源革命，由此引发了工业时代的到来。从那时起，随着人口密度的迅速增加，工业国家对于能源的需求成倍成倍增加。石油和天然气被看作是用途多、质量好的能源产品而得到开发，而铀也得以开发，为核反应堆提供燃料并供应原子能源。",
            "options": [],
            "correctOptionId": "",
          },
          {
          ...
          },
          {
            ...
            "textCN": "在不久的将来的某个时候，地球上最后一滴石油、最后一块煤或最后一缕天然气将被开采。迄今为止一直被证明是稳定可靠的矿物燃料终将消失，这让我们别无选择，只能作好准备，迎接新的能源综合利用时代的到来。可以肯定，人类对能源的需求不会趋于减少或保持稳定，而是会随着世界人口在未来50年增长到90亿而迅速增加。据预测，到2020年，全球的能源消耗将直线增长50%。",
            "options": [],
            "correctOptionId": "",
          },
          {
            ...
            "textCN": "我们怎样才能满足未来急剧增长的能源需求呢？在我们完善冷聚变技术之前，我们只能专注于开发太阳能、风能、水电能之类的可再生能源，并提高其产量。虽然可再生能源前景乐观，一个由科学家和工程师组成的国际联盟却正在积极工作，努力克服与这些“新兴能源”技术相关的各种障碍，其中最大的挑战就是如何使这些技术变得既高效又经济。",
            "options": [],
            "correctOptionId": "",
          },
          {
            ...
            "textCN": "以太阳能为例。由于耀眼的太阳光能够提供源源不断的能源，所以它是个不错的选择。但是，大规模地使用太阳能却是说起来容易做起来难。把制造太阳能所需要的复杂零件从“环保”社会的边缘推广到主流社会，使之成为世界主要的消费性能源，其代价之高让人望而却步。太阳能设备本身已是技术成熟，可以使商业和消费者进行许多新型应用，但是，在全球或者即便是在全国范围内，用新型的半导体和晶体管电子技术取代老式的用齿轮和发动机驱动的燃烧设备，其成本实在太高。",
            "options": [],
            "correctOptionId": "",
          },
          {
            ...
            "textCN": "风能在一些地方已经被几代人有效利用，目前在能源市场中也发展迅速。风能的原理是：风通过驱动涡轮机叶片按顺时针或逆时针方向绕着一个轴旋转，从而把转动时所产生的力转换成电能。不幸的是，风能非常不稳定，其强度取决于当地的天气模式、温度、季节以及地域。除了不稳定的因素之外，和其他能源相比，风能设备造价昂贵。除非我们能将其成本大大降低，否则风能就不会成为一个可行的替代能源。而且，一个“风能农场”需要大片空旷的土地才能生产大量能源。",
            "options": [],
            "correctOptionId": "",
          },
          {
            ...
            "textCN": "水力电能是另外一种既干净又能再生的能源。人们可以通过不同方法来控制自然水流以进行发电。最普遍的方法是通过水坝，但不幸的是，建水坝已被认为是对环境不利的方法了。世界上大多数用于水力发电的大坝建造历史都不长，但是所有的水库最终都会被淤泥填塞，需要耗资巨大进行清淤才能使它们重新得到利用。",
            "options": [],
            "correctOptionId": "",
          },
          {
            ...
            "textCN": "动植物物质所产生的生物能源也是一种可再生能源，且被认为是矿物燃料的备用替代品。以死树、枯叶、动物尸体以及食品加工废料的形式存在的有机废物十分充足，可以被用来制造能源。然而，将生物质作为燃料直接燃烧，通风时必然会将二氧化碳及其他温室气体排放到大气中。这些气体会对臭氧层造成威胁，增加人们受到来自太阳的有害紫外线照射的危险。除此以外，将生物质以原始形态进行收集，并将它们运送到某个中心站加工处理成燃料，这一过程既耗时又耗财，而且对这一过程实现自动化非常困难。所以，在目前，生物质能源有太多高成本方面的缺点，不能成为矿物燃料可行的替代品。",
            "options": [],
            "correctOptionId": "",
          },
          {
            ...
            "textCN": "虽然从经济实惠方面来说，可再生能源没有矿物能源有竞争力，但是，与燃烧煤和石油所带来的健康及环境代价相比，它们的价格又变得较有吸引力了。也许，对于日益紧迫的能源挑战，最好的解决办法正如“忧思科学家联盟”所出的一份简报上所说的那样：“未来我们社会的成功不能依赖于某一单一的解决方案。相反，答案须来自一系列各种不同的能源技术。这些技术有一个共同目的：它们不会耗尽我们的自然资源，也不会破坏我们的环境。”尽管困难重重，我们需要牢记的是，能源危机正以超音速逼近，即将来到我们面前。为了在能源领域开创一个新时代，我们必须赶快行动，努力寻求国际合作，以找到能源问题最有效的解决办法。",
            "options": [],
            "correctOptionId": "",
          }
        ]
