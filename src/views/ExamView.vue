<template>
  <div class="exam-container p-4">
    ...
    <!-- 阅读理解文章 -->
    <div v-if="currentSet?.type === 'reading' && currentSet.article" class="article-container mb-6 bg-white rounded-lg shadow-md p-4">
    ...
    <!-- 问题区域 -->
    <div v-if="currentQuestion" class="question-container bg-white rounded-lg shadow-md p-4 mb-6">
    ...
    <!-- 答题结果 -->
    <div v-if="selectedOptionId" class="result-container mb-6">
      <div 
